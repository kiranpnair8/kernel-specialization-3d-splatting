...
#SBATCH --output=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/phase3/drk/phase3b_drk_%A_%a.out
#SBATCH --error=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/phase3/drk/phase3b_drk_%A_%a.err
...
mkdir -p "$PROJECT_ROOT/jobs/logs/phase3/drk"
...
echo "============================================================"
echo "DRK SYNTHETIC PHASE III-B MULTI-SEED"
...
echo "DRK Phase III-B task complete: $SCENE_ID at $(date)"
