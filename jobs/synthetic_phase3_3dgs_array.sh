...
#SBATCH --output=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/phase3/3dgs/synthetic_3dgs_%A_%a.out
#SBATCH --error=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/phase3/3dgs/synthetic_3dgs_%A_%a.err
...
mkdir -p "$OUTPUT" "$PROJECT_ROOT/jobs/logs/phase3/3dgs"
