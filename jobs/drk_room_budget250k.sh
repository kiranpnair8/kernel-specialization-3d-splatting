...
#SBATCH --output=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/drk_room_budget250k_%j.out
#SBATCH --error=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/drk_room_budget250k_%j.err
...
OUTPUT=$PROJECT_ROOT/outputs/drk/room_budget250k
...
echo "============================================================"
echo "DRK ROOM 250K PRIMITIVE-BUDGET VARIANT"
echo "============================================================"
...
echo
echo "============================================================"
echo "DRK ROOM 250K PRIMITIVE-BUDGET VARIANT COMPLETE"
echo "Finished: $(date)"
echo "============================================================"
