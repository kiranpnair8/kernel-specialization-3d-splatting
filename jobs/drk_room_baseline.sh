...
#SBATCH --output=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/drk_room_%j.out
#SBATCH --error=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/drk_room_%j.err
...
OUTPUT=$PROJECT_ROOT/outputs/drk/room_baseline
...
echo
echo "============================================================"
echo "DRK ROOM BASELINE COMPLETE"
echo "Finished: $(date)"
echo "============================================================"
