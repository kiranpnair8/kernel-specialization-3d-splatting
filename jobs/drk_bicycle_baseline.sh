...
#SBATCH --output=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/drk_bicycle_%j.out
#SBATCH --error=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/drk_bicycle_%j.err
...
OUTPUT=$PROJECT_ROOT/outputs/drk/bicycle_baseline
...
echo
echo "============================================================"
echo "DRK BICYCLE BASELINE COMPLETE"
echo "Finished: $(date)"
echo "============================================================"
