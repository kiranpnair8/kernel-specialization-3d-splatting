...
#SBATCH --output=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/ges_bicycle_%j.out
#SBATCH --error=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/ges_bicycle_%j.err
...
OUTPUT=$PROJECT_ROOT/outputs/ges/bicycle_baseline
...
echo
echo "============================================================"
echo "GES BICYCLE BASELINE COMPLETE"
echo "Finished: $(date)"
echo "============================================================"
