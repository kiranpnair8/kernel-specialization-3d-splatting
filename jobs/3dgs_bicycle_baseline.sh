...
#SBATCH --output=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/3dgs_bicycle_%j.out
#SBATCH --error=/home/rizk_lab/shared/kiran/kernel-specialization-3d-splatting/jobs/logs/3dgs_bicycle_%j.err
...
DATASET=$PROJECT_ROOT/datasets/mipnerf360/bicycle
OUTPUT=$PROJECT_ROOT/outputs/3dgs/bicycle_baseline
...
echo
echo "============================================================"
echo "3DGS BICYCLE BASELINE COMPLETE"
echo "Finished: $(date)"
echo "============================================================"
